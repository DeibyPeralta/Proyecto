...
public class cantores extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap map) {
        LatLng upc = new LatLng(10.485448, -73.256697);       // Add a marker in upc and move the camera
        map.addMarker(new MarkerOptions().position(upc).title("Tierra de cantores bar"));
