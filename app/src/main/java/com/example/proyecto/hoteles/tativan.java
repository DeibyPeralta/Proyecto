...
public class tativan extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tativan);
        ...
        wifi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(tativan.this, "Wifi (gratis)", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        bar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(tativan.this, "Excelentes bebidas en el bar", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        comida.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(tativan.this, "Muy buen desayuno", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        calificar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(tativan.this, "calificaste con " + ranking + "estrellas", Toast.LENGTH_SHORT).show();
            }
        });
    }
    @Override
